...
g++-6 -O2 cnF2freq7.cpp -ffast-math  -o cnF2freq7 -fopenmp -I boost_1_57_0 -g
...
./cnF2freq7 demoplantimpute.map demoplantimpute.ped demoplantimpute.gen demooutput 10
