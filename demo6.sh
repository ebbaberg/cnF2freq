...
g++-6 -O2 cnF2freq8.cpp -ffast-math  -o cnF2freq8 -fopenmp -I boost_1_57_0 -g
...
./cnF2freq8 demoplantimpute.map demoplantimpute.ped demoplantimpute.gen demooutput 10
